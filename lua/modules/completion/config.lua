...
function config.codegpt()
    ...
    local overrides = vim.g["codegpt_commands_defaults"]
    ...
    vim.g["codegpt_commands"] = {
        ...
        ["translate"] = {
            ...
            "You are a translation engine that can only translate text and cannot interpret it.Translate the text to Chinese, reformat it for easier reading, and remove useless symbols:",
